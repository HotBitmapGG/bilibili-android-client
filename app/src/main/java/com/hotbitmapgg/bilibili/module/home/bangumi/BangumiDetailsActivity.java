...
public class BangumiDetailsActivity extends RxBaseActivity {
  ...
  public void loadData() {
    ...
    RetrofitHelper.getBangumiAPI()
        ...
        .flatMap(
            new Func1<List<BangumiDetailsRecommendInfo.ResultBean.ListBean>, Observable<BangumiDetailsCommentInfo>>() {
  ...
  private void initSeasonsRecycler() {
    ...
    BangumiDetailsSeasonsAdapter mBangumiDetailsSeasonsAdapter = new BangumiDetailsSeasonsAdapter(
        mBangumiSeasonsRecycler, seasons);
  ...
  private void initRecommendRecycler() {
    ...
    mBangumiRecommendRecycler.setLayoutManager(
        new GridLayoutManager(BangumiDetailsActivity.this, 3));
