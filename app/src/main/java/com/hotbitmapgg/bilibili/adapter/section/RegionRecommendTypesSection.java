...
public class RegionRecommendTypesSection extends StatelessSection {
  ...
  public RegionRecommendTypesSection(Context context, int rid) {
    ...
    super(R.layout.layout_region_recommend_types,
  ...
  private void setRecyclerAdapter(TypesViewHolder typesViewHolder) {
    ...
    switch (rid) {
      case 13:
        ...
        mAdapter = new RegionRecommendTypesAdapter(typesViewHolder.mRecyclerView, bangumiIcons,
            bangumiTitles);
        break;
      case 1:
        //动画
        typesViewHolder.mRecyclerView.setLayoutManager(new GridLayoutManager(mContext, 4));
        mAdapter = new RegionRecommendTypesAdapter(typesViewHolder.mRecyclerView, animationIcons,
            animationTitles);
        break;
      case 3:
        //音乐
        typesViewHolder.mRecyclerView.setLayoutManager(new GridLayoutManager(mContext, 4));
        mAdapter = new RegionRecommendTypesAdapter(typesViewHolder.mRecyclerView, musicIcons,
            musicTitles);
        break;
      case 129:
        //舞蹈
      ...
      case 4:
        //游戏
        typesViewHolder.mRecyclerView.setLayoutManager(new GridLayoutManager(mContext, 4));
        mAdapter = new RegionRecommendTypesAdapter(typesViewHolder.mRecyclerView, gameIcons,
            gameTitles);
        break;
      case 36:
        //科技
        typesViewHolder.mRecyclerView.setLayoutManager(new GridLayoutManager(mContext, 4));
        mAdapter = new RegionRecommendTypesAdapter(typesViewHolder.mRecyclerView, scienceIcons,
            scienceTitles);
        break;
      case 160:
        //生活
        typesViewHolder.mRecyclerView.setLayoutManager(new GridLayoutManager(mContext, 4));
        mAdapter = new RegionRecommendTypesAdapter(typesViewHolder.mRecyclerView, lifeIcons,
            lifeTitles);
        break;
      case 119:
        //鬼畜
        typesViewHolder.mRecyclerView.setLayoutManager(new GridLayoutManager(mContext, 4));
        mAdapter = new RegionRecommendTypesAdapter(typesViewHolder.mRecyclerView, kichikuIcons,
            kichikuTitles);
        break;
      case 155:
        //时尚
        typesViewHolder.mRecyclerView.setLayoutManager(new GridLayoutManager(mContext, 4));
        mAdapter = new RegionRecommendTypesAdapter(typesViewHolder.mRecyclerView, fashionIcons,
            fashionTitles);
        break;
      case 5:
        //娱乐
        typesViewHolder.mRecyclerView.setLayoutManager(new GridLayoutManager(mContext, 3));
        mAdapter = new RegionRecommendTypesAdapter(typesViewHolder.mRecyclerView,
            entertainmentIcons, entertainmentTitles);
        break;
      case 23:
        //电影
        typesViewHolder.mRecyclerView.setLayoutManager(new GridLayoutManager(mContext, 4));
        mAdapter = new RegionRecommendTypesAdapter(typesViewHolder.mRecyclerView, movieIcons,
            movieTitles);
        break;
      case 11:
        //电视剧
        typesViewHolder.mRecyclerView.setLayoutManager(new GridLayoutManager(mContext, 4));
        mAdapter = new RegionRecommendTypesAdapter(typesViewHolder.mRecyclerView, tvIcons,
            tvTitles);
        break;
    }
