...
public class SeasonNewBangumiSection extends StatelessSection {
  ...
  public void onBindItemViewHolder(RecyclerView.ViewHolder holder, int position) {
    ...
    SeasonNewBangumiSection.ItemViewHolder itemViewHolder
        = (SeasonNewBangumiSection.ItemViewHolder) holder;
  ...
  public void onBindHeaderViewHolder(RecyclerView.ViewHolder holder) {
    ...
    SeasonNewBangumiSection.HeadViewHolder headViewHolder
        = (SeasonNewBangumiSection.HeadViewHolder) holder;
