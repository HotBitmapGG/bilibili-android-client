...
/**
 * <p>
 * This class encapsulates scrolling. You can use scrollers ({Scroller} or
 * {OverScroller}) to collect the data you need to produce a scrolling
...
public class ScrollableScroller
{
	...
	/**
	 * Stops the animation. Contrary to {forceFinished(boolean)}, aborting the
