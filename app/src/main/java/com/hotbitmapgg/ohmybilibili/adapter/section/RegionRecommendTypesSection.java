...
public class RegionRecommendTypesSection extends StatelessSection
{
    ...
    //音乐类型titles
    private String[] musicTitles = new String[]{"翻唱", "VOCALOID·UTAU", "演奏", "OP/ED/OST", "原创音乐", "三次元音乐", "音乐选集"};
    ...
    //科技类型titles
    private String[] scienceTitles = new String[]{"纪录片", "趣味科普人文", "野生技术协会", "演讲·公开课", "星海", "数码", "机械"};
    ...
    private void setRecyclerAdapter(TypesViewHolder typesViewHolder)
    {
        ...
        switch (rid)
        {
            ...
            case 129:
                ...
                mAdapter = new RegionRecommendTypesAdapter(typesViewHolder.mRecyclerView, danceIcons, danceTitles);
                break;
            case 4:
                //游戏
                typesViewHolder.mRecyclerView.setLayoutManager(new GridLayoutManager(mContext, 4));
