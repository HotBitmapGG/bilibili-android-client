...
public class PartitionInfo implements Parcelable
{
    ...
    protected PartitionInfo(Parcel in)
    {
    ...
    public static final Creator<PartitionInfo> CREATOR = new Creator<PartitionInfo>()
    {

        @Override
        public PartitionInfo createFromParcel(Parcel source)
        {
        ...
        @Override
        public PartitionInfo[] newArray(int size)
        {

            return new PartitionInfo[size];
        }
    };
}
